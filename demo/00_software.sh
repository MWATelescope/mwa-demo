...
# multiplatform
export python="$docker_base --entrypoint=python 'd3vnull0/mwa-demo:test' "
export giant_squid="$docker_base -e MWA_ASVO_API_KEY=\$MWA_ASVO_API_KEY --entrypoint giant-squid 'd3vnull0/mwa-demo:test' "
export run_prepqa="$docker_base --entrypoint=python 'd3vnull0/mwa-demo:test' /usr/local/bin/run_prepvisqa.py"
export plot_prepqa="$docker_base --entrypoint=python 'd3vnull0/mwa-demo:test' /usr/local/bin/plot_prepvisqa.py "
export run_calqa="$docker_base --entrypoint=python 'd3vnull0/mwa-demo:test' /usr/local/bin/run_calqa.py "
export plot_calqa="$docker_base --entrypoint=python 'd3vnull0/mwa-demo:test' /usr/local/bin/plot_calqa.py "
export wsclean="$docker_base --entrypoint=wsclean 'd3vnull0/mwa-demo:test'"
...
export hyperdrive="$docker_base --platform linux/amd64 --entrypoint hyperdrive -e MWA_BEAM_FILE=\$MWA_BEAM_FILE d3vnull0/mwa-demo-amd64:latest"
